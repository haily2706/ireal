                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 leading-tight">
                            ...
                            <span className="bg-gradient-to-r from-brand-blue via-purple-500 to-brand-gold bg-clip-text text-transparent">
                                Web3 Finance
                            </span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Button size="lg" className="bg-gradient-to-r from-brand-blue to-purple-600 hover:opacity-90 transition-opacity">
                                Create Wallet
                            </Button>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className="glass p-6 rounded-2xl h-full border border-white/5 hover:border-brand-blue/30 transition-all duration-300 hover:translate-y-[-5px]">
