    ...
    return (
        <section id="how-it-works" className="py-24 px-4 relative">
            <div className="container mx-auto max-w-6xl">
                ...
                >
                    <span className="inline-block px-4 py-1.5 rounded-full glass text-sm font-medium text-purple-400 mb-4">
                        Simple Process
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    <div className="hidden md:block absolute top-1/2 left-1/4 right-1/4 h-0.5 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 -translate-y-1/2 z-0" />
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="glass rounded-2xl p-8 text-center hover:scale-105 transition-transform duration-300">
                                {/* Step Number */}
                                <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center text-sm font-bold">
                                    {index + 1}
                                </div>
                                ...
                                <div className={`w-20 h-20 rounded-2xl ${step.bgColor} flex items-center justify-center mx-auto mb-6`}>
                                    <step.icon className="w-10 h-10" style={{
                                        color: index === 0 ? '#ec4899' : index === 1 ? '#a855f7' : '#06b6d4'
                                    }} />
                                </div>
